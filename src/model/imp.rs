...
use crate::capture::{TrafficItem, TrafficViewMode, DeviceItem};
use crate::row_data::{TrafficRowData, DeviceRowData};
use crate::tree_list_model::TreeListModel;

#[derive(Default)]
pub struct TrafficModel {
    pub(super) tree: RefCell<Option<TreeListModel<TrafficItem, super::TrafficModel, TrafficRowData, TrafficViewMode>>>,
}
